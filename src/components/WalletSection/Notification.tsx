...
const classHasNotification =
  "after:content-[''] after:w-2 after:h-2 after:bg-cyan-500 block after:rounded-full after:absolute after:bottom-3/4  after:left-3/4";
...
const Notification: React.FC = () => {
  ...
  return (
    <div className="sm:mr-4 md:mr-6 ml-auto grid place-items-center relative">
      ...
      >
        <IconBell className="fill-teal-600 w-5 h-5 md:w-6 md:h-6 dark:fill-teal-600" />
      </button>
          ...
          {uncompletedTasks.length > 0 ? (
            <div>
              ...
              {moreTasksToShow && (
                <a
                  href="/"
                  className="transition block w-full rounded-md p-1 bg-cyan-100 text-cyan-600 dark:text-slate-200 dark:bg-slate-700/[.3] text-center"
                >
                  See today's tasks
                </a>
              )}
